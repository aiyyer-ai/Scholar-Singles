...
window.onload = (event) => {
      ...
      let vaseRotation = window.sessionStorage.getItem(`vase1Rotation`);
      let vase = document.getElementById('vase');
      if (vaseRotation) {
            vase.src = `./images/0_a${vaseRotation}.webp`;
...
function rotateVase(clockwise) {
      ...
      vase.src = `./images/0_a${rotationNumber}.webp`;
      vase.rotation = rotationNumber;
      console.log(rotationNumber);
      window.sessionStorage.setItem(`vase1Rotation`, rotationNumber);
      setTimeout(() => {
