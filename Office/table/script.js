...
function dragElement(elmnt) {
      ...
      if (document.getElementById(elmnt.id + "header")) {
            ...
            if (inventoryItem) {
                  ...
                  elmnt.originalPosition = elmnt.offsetTop;
                  if (elmnt.children[0].src.includes(`teacup1`)) {
                        elmnt.goesDown = false;
                  } else {
                        elmnt.goesDown = true;
                  }
      ...
      function elementDrag(e) {
            ...
            if (!inventoryItem) {
                  if (elmnt.goesDown) {
                        elmnt.style.top = Math.max(Math.min((elmnt.offsetTop - pos2), elmnt.originalPosition + elmnt.clientHeight * 1.07), elmnt.originalPosition) + "px";
                  } else {
                        elmnt.style.top = Math.min(Math.max((elmnt.offsetTop - pos2), elmnt.originalPosition - elmnt.clientHeight * 1.07), elmnt.originalPosition) + "px";
                  }
            } else {
